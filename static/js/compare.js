...
const categories = {
  "신체부위": ["eyes", "eye", "face", "arm", "arms", "leg", "breast", "breasts", "legs", "ass", "nipples", "nipple", "bare_shoulders", "barefoot", "lips", "nose", "forehead", "tongue", "anus"],
  "헤어": ["hair", "bangs", "ponytail", "twintails", "twin_drills"],
  "의류": ["shirt", "skirt", "pants", "jacket", "thighhighs", "sleeves", "sweater", "turtleneck", "underwear", "panties", "bra", "denim", "tank_top", "jeans", "gloves", "frills", "shoes", "dress", "footwear", "high_heels", "lace_trim", "mary_janes", "lolita"],
  ...
  "악세사리": ["bow", "cuffs", "tattoo", "eyewear", "glasses", "ribbon", "piercing", "earrings", "choker"],
  "공간구성": ["interior", "livingroom", "bed", "tiles", "tile_floor", "indoors", "sky", "cloud", "public_indecency", "background", "pillow"],
  "여성": ["arched_back", "pussy", "cum_in", "cum_on", "off_shoulder", "eyelashes", "saliva", "oral", "fellatio", "long_fingernails", "mascara", "two_side_up", "stomach"],
  ...
  "관점과시점": ["from_side", "solo_focus", "out_of_frame", "looking_back", "profile"],
  "미사용": ["hetero"],
  "기타": []  
};
