...
const categories = {
  ...
  "디테일": ["shiny_skin", "saliva_trail", "tan", "tanlines", "one-piece_tan", "bikini_tan", "cum", "nails"],
  "악세사리": ["bow", "cuffs", "tattoo", "eyewear", "glasses", "ribbon", "piercing", "earrings", "choker", "bracelet", "hairbad"],
  "공간구성": ["interior", "livingroom", "bed", "tiles", "tile_floor", "indoors", "sky", "cloud", "public_indecency", "background", "pillow", "lamp", "bedroom", "room"],
